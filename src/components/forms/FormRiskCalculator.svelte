...
<section class="w-full sm:max-w-5xl mx-auto" style="margin-bottom: 4rem;" >
	<div class="section-header text-center mb-10">
		<h1 class="text-2xl md:text-4xl font-semibold text-gray-900" style="color: tomato; font-size:3em" >Stocks Risk & Quantity Calculator</h1>
	</div>
	<div class="section-body grid grid-cols-1 gap-4 md:grid-cols-2">
		<div class="bg-green rounded-lg shadow" style="background-color: green;" >
		...
		<div class="bg-lightseagreen rounded-lg shadow grid-cols-2" style="background-color: lightseagreen;" >
			<div class="p-6 space-y-4 md:space-y-6 sm:p-8">
